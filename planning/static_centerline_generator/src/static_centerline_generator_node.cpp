...
{
  const auto start_lanelets = route_handler_ptr_->getClosestLanelets(points.front().pose);
  const auto end_lanelets = route_handler_ptr_->getClosestLanelets(points.back().pose);
